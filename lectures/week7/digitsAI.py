...
# hidden_size = (input_size + output_size) // 2, MNIST 28x28 = 784, ouputsize = 10
...
model = Sequential([
    ...
    # Innebär att vi tittar på 2x2-regioner i bilden, hittar "basic patterns" i dessa, d.v.s tar ut de viktigaste detaljerna/mönstren i bilden
    ...
    Dense(128, activation='relu'), # Tar alla hittade mönster/detaljer och bestämmer siffran.
    ...
    # Output layer. SoftMax-funktion lämpligt för multi-klassificerings-problem.
